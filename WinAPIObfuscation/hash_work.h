...
inline HANDLE hash_CreateFileA(__in LPCSTR file_name, __in DWORD access, __in DWORD share_mode, __in LPSECURITY_ATTRIBUTES security, __in DWORD creation_disposition, __in DWORD flags, __in HANDLE template_file)
{
...
inline BOOL hash_VirtualProtect(LPVOID lpAddress, SIZE_T dwSize, DWORD flNewProtect, PDWORD lpflOldProtect)
{
...
inline LPVOID hash_VirtualAlloc(LPVOID lpAddress, SIZE_T dwSize, DWORD flAllocationType, DWORD flProtect)
{
...
inline BOOL hash_VirtualFree(LPVOID lpAddress, SIZE_T dwSize, DWORD dwFreeType)
{
...
inline LPVOID hash_VirtualAllocEx(HANDLE hProcess, LPVOID lpAddress, SIZE_T dwSize, DWORD flAllocationType, DWORD flProtect)
{
...
inline BOOL hash_VirtualFreeEx(HANDLE hProcess, LPVOID lpAddress, SIZE_T dwSize, DWORD dwFreeType)
{
...
inline DWORD hash_QueryDosDeviceW(LPCWSTR lpDeviceName, LPWSTR lpTargetPath, DWORD ucchMax)
{
...
inline BOOL hash_GetDiskFreeSpaceExW(LPCWSTR lpDirectoryName, PULARGE_INTEGER lpFreeBytesAvailableToCaller, PULARGE_INTEGER lpTotalNumberOfBytes, PULARGE_INTEGER lpTotalNumberOfFreeBytes)
{
...
inline HMODULE hash_LoadLibraryW(LPCWSTR lpLibFileName)
{
...
inline BOOL hash_GetModuleHandleExW(DWORD dwFlags, LPCWSTR lpModuleName, HMODULE* phModule)
{
...
inline DWORD hash_GetModuleFileNameW(HMODULE hModule, LPWSTR lpFilename, DWORD nSize)
{
...
inline HMODULE hash_GetModuleHandleA(LPCSTR lpModuleName)
{
...
inline HMODULE hash_GetModuleHandleW(LPCWSTR lpModuleName)
{
...
inline FARPROC hash_GetProcAddress(HMODULE hModule, LPCSTR lpProcName)
{
...
inline HANDLE hash_GetStdHandle(_In_ DWORD nStdHandle)
{
...
inline BOOL hash_GetConsoleScreenBufferInfo(_In_ HANDLE hConsoleOutput, _Out_ PCONSOLE_SCREEN_BUFFER_INFO lpConsoleScreenBufferInfo)
{
...
inline BOOL hash_SetConsoleTextAttribute(_In_ HANDLE hConsoleOutput, _In_ WORD wAttributes)
{
...
inline DWORD hash_GetTickCount()
{
...
inline BOOL hash_VerifyVersionInfoW(LPOSVERSIONINFOEXA lpVersionInformation, DWORD dwTypeMask, DWORDLONG dwlConditionMask)
{
...
inline UINT hash_GetSystemWindowsDirectoryW(LPWSTR lpBuffer, UINT uSize)
{
...
inline UINT hash_GetWindowsDirectoryW(LPWSTR lpBuffer, UINT uSize)
{
...
inline UINT hash_GetSystemDirectoryW(LPWSTR lpBuffer, UINT uSize)
{
...
inline UINT hash_GetSystemDirectoryA(LPSTR lpBuffer, UINT uSize)
{
	const auto lenSeed = 20;
...
inline void hash_GetSystemInfo(LPSYSTEM_INFO lpSystemInfo)
{
...
inline DWORD hash_ExpandEnvironmentStringsW(LPCWSTR lpSrc, LPWSTR lpDst, DWORD nSize)
{
...
inline BOOL hash_QueryPerformanceCounter(LARGE_INTEGER* lpPerformanceCount)
{
...
inline BOOL hash_IsProcessorFeaturePresent(DWORD ProcessorFeature)
{
	const auto lenSeed = 26;
...
//TODO: needed fix
inline PVOID hash_AddVectoredExceptionHandler(ULONG First, PVECTORED_EXCEPTION_HANDLER Handler)
{
...
inline void hash_SetLastError(DWORD dwErrCode)
{
	const auto lenSeed = 13;
...
inline _Post_equals_last_error_ DWORD hash_GetLastError()
{
	const auto lenSeed = 13;
...
inline void hash_OutputDebugStringW(LPCWSTR lpOutputString)
{
	const auto lenSeed = 19;
...
inline DWORD hash_FormatMessageW(DWORD dwFlags, LPCVOID lpSource, DWORD dwMessageId, DWORD dwLanguageId, LPWSTR lpBuffer, DWORD nSize, va_list* Arguments)
{
...
inline HANDLE hash_CreateMutexW(LPSECURITY_ATTRIBUTES lpMutexAttributes, BOOL bInitialOwner, LPCWSTR lpName)
{
	const auto lenSeed = 13;
...
inline HANDLE hash_CreateEventW(LPSECURITY_ATTRIBUTES lpEventAttributes, BOOL bManualReset, BOOL bInitialState, LPCWSTR lpName)
{
	const auto lenSeed = 13;
...
inline BOOL hash_SetEvent(HANDLE hEvent)
{
...
inline DWORD hash_WaitForSingleObject(HANDLE hHandle, DWORD dwMilliseconds)
{
	const auto lenSeed = 20;
...
inline DWORD hash_QueueUserAPC(PAPCFUNC pfnAPC, HANDLE hThread, ULONG_PTR dwData)
{
	const auto lenSeed = 13;
...
inline HANDLE hash_CreateThread(LPSECURITY_ATTRIBUTES lpThreadAttributes, SIZE_T dwStackSize, LPTHREAD_START_ROUTINE lpStartAddress, __drv_aliasesMem LPVOID lpParameter, DWORD dwCreationFlags, LPDWORD lpThreadId)
{
	const auto lenSeed = 13;
	const auto _hash = MurmurHash2A("CreateEventW", lenSeed, lenSeed);
...
inline HANDLE hash_CreateWaitableTimerW(LPSECURITY_ATTRIBUTES lpTimerAttributes, BOOL bManualReset, LPCWSTR lpTimerName)
{
	const auto lenSeed = 21;
...
inline BOOL hash_SetWaitableTimer(HANDLE hTimer, const LARGE_INTEGER* lpDueTime, LONG lPeriod, PTIMERAPCROUTINE pfnCompletionRoutine, LPVOID lpArgToCompletionRoutine, BOOL fResume)
{
...
inline BOOL hash_CancelWaitableTimer(HANDLE hTimer)
{
	const auto lenSeed = 20;
...
inline BOOL hash_CreateTimerQueueTimer(PHANDLE phNewTimer, HANDLE TimerQueue, WAITORTIMERCALLBACK Callback, PVOID DueTime, DWORD Period, DWORD Flags, ULONG Parameter)
{
...
inline DWORD hash_SetFilePointer(HANDLE hFile, LONG lDistanceToMove, PLONG lpDistanceToMoveHigh, DWORD dwMoveMethod)
{
	const auto lenSeed = 15;
...
inline BOOL hash_ReadFile(HANDLE hFile, LPVOID lpBuffer, DWORD nNumberOfBytesToRead, LPDWORD lpNumberOfBytesRead, LPOVERLAPPED lpOverlapped)
{
	const auto lenSeed = 9;
...
inline HANDLE hash_CreateFileW(LPCWSTR lpFileName, DWORD dwDesiredAccess, DWORD dwShareMode, LPSECURITY_ATTRIBUTES lpSecurityAttributes, DWORD dwCreationDisposition, DWORD dwFlagsAndAttributes, HANDLE hTemplateFile)
{
...
inline DWORD hash_GetFullPathNameW(LPCWSTR lpFileName, DWORD nBufferLength, LPWSTR lpBuffer, LPWSTR* lpFilePart)
{
	const auto lenSeed = 17;
...
inline DWORD hash_GetFileAttributesW(LPCWSTR lpFileName)
{
	const auto lenSeed = 19;
...
inline void hash_GetSystemTimeAsFileTime(LPFILETIME lpSystemTimeAsFileTime)
{
	const auto lenSeed = 24;
...
inline SIZE_T hash_VirtualQuery(LPCVOID lpAddress, PMEMORY_BASIC_INFORMATION lpBuffer, SIZE_T dwLength)
{
	const auto lenSeed = 13;
...
inline BOOL hash_ReadProcessQMemory(HANDLE hProcess, LPCVOID lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T* lpNumberOfBytesRead)
{
	const auto lenSeed = 18;
...
/*DECLSPEC_ALLOCATOR*/
inline HLOCAL hash_LocalAlloc(UINT uFlags, SIZE_T uBytes)
{
...
inline HLOCAL hash_LocalFree(_Frees_ptr_opt_ HLOCAL hMem)
{
...
inline BOOL hash_GlobalMemoryStatusEx(LPMEMORYSTATUSEX lpBuffer)
{
	const auto lenSeed = 21;
...
inline BOOL hash_WriteProcessMemory(HANDLE hProcess, LPVOID lpBaseAddress, LPCVOID lpBuffer, SIZE_T nSize, SIZE_T* lpNumberOfBytesWritten)
{
	const auto lenSeed = 19;
...
inline SIZE_T hash_LocalSize(HLOCAL hMem)
{
	const auto lenSeed = 10;
...
inline LPVOID hash_HeapAlloc(HANDLE hHeap, DWORD dwFlags, SIZE_T dwBytes)
{
	const auto lenSeed = 10;
...
inline HANDLE hash_GetProcessHeap()
{
	const auto lenSeed = 15;
...
inline BOOL hash_HeapFree(HANDLE hHeap, DWORD dwFlags, _Frees_ptr_opt_ LPVOID lpMem)
{
	const auto lenSeed = 9;
...
inline BOOL hash_IsBadReadPtr(const VOID* lp, UINT_PTR ucb)
{
	const auto lenSeed = 13;
...
inline HANDLE hash_GetCurrentProcess()
{
	const auto lenSeed = 18;
...
inline BOOL hash_GetThreadContext(HANDLE hThread, LPCONTEXT lpContext)
{
	const auto lenSeed = 17;
...
inline void hash_Sleep(DWORD dwMilliseconds)
{
...
inline DWORD hash_GetCurrentProcessId()
{
	const auto lenSeed = 20;
...
inline HANDLE hash_OpenProcess(DWORD dwDesiredAccess, BOOL bInheritHandle, DWORD dwProcessId)
{
	const auto lenSeed = 12;
...
inline DWORD hash_GetEnvironmentVariableW(LPCWSTR lpName, LPWSTR lpBuffer, DWORD nSize)
{
	const auto lenSeed = 24;
...
inline HANDLE hash_CreateToolhelp32Snapshot(DWORD dwFlags, DWORD th32ProcessID)
{
...
inline BOOL hash_Module32FirstW(HANDLE hSnapshot, LPMODULEENTRY32W lpme)
{
	const auto lenSeed = 15;
...
inline BOOL hash_Module32NextW(HANDLE hSnapshot, LPMODULEENTRY32W lpme)
{
	const auto lenSeed = 14;
...
inline BOOL hash_SwitchToThread()
{
	const auto lenSeed = 15;
...
inline BOOL hash_IsWow64Process(HANDLE hProcess, PBOOL Wow64Process)
{
	const auto lenSeed = 15;
...
inline HANDLE hash_CreateRemoteThread(HANDLE hProcess, LPSECURITY_ATTRIBUTES lpThreadAttributes, SIZE_T dwStackSize, LPTHREAD_START_ROUTINE lpStartAddress, LPVOID lpParameter, DWORD dwCreationFlags, LPDWORD lpThreadId)
{
	const auto lenSeed = 19;
...
inline BOOL hash_Thread32First(HANDLE hSnapshot, LPTHREADENTRY32 lpte)
{
	const auto lenSeed = 14;
...
inline HANDLE hash_OpenThread(DWORD dwDesiredAccess, BOOL bInheritHandle, DWORD dwThreadId)
{
	const auto lenSeed = 11;
...
inline BOOL hash_Thread32Next(HANDLE hSnapshot, LPTHREADENTRY32 lpte)
{
	const auto lenSeed = 13;
...
inline BOOL hash_Process32FirstW(HANDLE hSnapshot, LPTHREADENTRY32 lpte)
{
...
inline BOOL hash_Process32NextW(HANDLE hSnapshot, LPTHREADENTRY32 lpte)
{
	const auto lenSeed = 15;
...
inline DWORD hash_GetCurrentThreadId()
{
	const auto lenSeed = 19;
...
inline BOOL hash_TerminateProcess(HANDLE hProcess, UINT uExitCode)
{
	const auto lenSeed = 17;
...
inline BOOL hash_CloseHandle(HANDLE hObject)
{
	const auto lenSeed = 12;
...
inline BOOL hash_DuplicateHandle(HANDLE hSourceProcessHandle, HANDLE hSourceHandle, HANDLE hTargetProcessHandle, LPHANDLE lpTargetHandle, DWORD dwDesiredAccess, BOOL bInheritHandle, DWORD dwOptions)
{
	const auto lenSeed = 16;
...
inline BOOL hash_SetHandleInformation(HANDLE hObject, DWORD dwMask, DWORD dwFlags)
{
	const auto lenSeed = 21;
...
inline BOOL hash_DeviceIoControl(HANDLE hDevice, DWORD dwIoControlCode, LPVOID lpInBuffer, DWORD nInBufferSize, LPVOID lpOutBuffer, DWORD nOutBufferSize, LPDWORD lpBytesReturned, LPOVERLAPPED lpOverlapped)
{
	const auto lenSeed = 16;
...
inline int hash_lstrlenW(LPCWSTR lpString)
{
	const auto lenSeed = 9;
...
inline int hash_MultiByteToWideChar(UINT CodePage, DWORD dwFlags, _In_NLS_string_(cbMultiByte)LPCCH lpMultiByteStr, int cbMultiByte, LPWSTR lpWideCharStr, int cchWideChar)
{
	const auto lenSeed = 20;
...
inline HANDLE hash_CreateTimerQueue()
{
	const auto lenSeed = 17;
...
inline BOOL hash_DeleteTimerQueueEx(HANDLE TimerQueue, HANDLE CompletionEvent)
{
	const auto lenSeed = 19;
...
inline BOOL hash_CheckRemoteDebuggerPresent(HANDLE hProcess, PBOOL pbDebuggerPresent)
{
	const auto lenSeed = 27;
...
inline LONG hash_UnhandledExceptionFilter(_EXCEPTION_POINTERS* ExceptionInfo)
{
	const auto lenSeed = 25;
...
inline LPTOP_LEVEL_EXCEPTION_FILTER hash_SetUnhandledExceptionFilter(LPTOP_LEVEL_EXCEPTION_FILTER lpTopLevelExceptionFilter)
{
	const auto lenSeed = 28;
...
inline ULONG hash_RemoveVectoredExceptionHandler(PVOID Handle)
{
