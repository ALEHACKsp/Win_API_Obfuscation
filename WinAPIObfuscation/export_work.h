...
inline static LPVOID parse_export_table(HMODULE module, DWORD api_hash, int len, unsigned int seed)
{
...
inline LPVOID get_api(DWORD api_hash, LPCSTR module, int len, unsigned int seed)
{
	HMODULE krnl32, hDll;
	LPVOID api_func;
